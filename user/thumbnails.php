...
if(!empty($_POST['size_id'])){
	...
	if((@$_POST['size_build'] == 'build') and ($fsip->countNotes('error') == 0)){
		...
		echo "<h1>Redirecting</h1><p>You are being redirected. If you're still here after a few seconds please ".'<a href="'. LOCATION . BASE . ADMIN . 'maintenance' . URL_CAP . '#build-thumbnail">'."click here</a></p>";
		exit();
	}
