...
// Require that there is a valid logged in user or redirect to login page
$user->isLoggedIn(true);

// In the user profile you can only modify your own profile.
// Admins who want to create or edit users should go to the admin dashboard
