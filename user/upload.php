...
if(isset($_GET['success']) and ($_GET['success'] == 1)){
	...
	echo "<h1>Redirecting</h1><p>You are being redirected. If you're still here after a few seconds please ".'<a href="'. LOCATION . BASE . ADMIN . 'shoebox' . URL_CAP .'">'."click here</a></p>";
	exit();
}
