...
?>
	...
	<div class="actions"><a href="<?php echo BASE . ADMINFOLDER . 'pages' . URL_ACT . 'add' . URL_RW; ?>"><button>Add page</button></a></div>
	
	<h1><img src="<?php echo BASE . IMGFOLDER; ?>icons/pages.png" alt="" /> Pages (<?php echo $pages->page_count; ?>)</h1>
...
?>
	...
	<div class="actions">
		...
		<a href="<?php echo BASE . ADMINFOLDER . 'search' . URL_ACT . 'pages' . URL_AID .  $page['page_id'] . URL_RW; ?>"><button>View images</button></a>
...
<?php
	...
	if (empty($page['page_title'])) {
		echo '<h1><img src="' . BASE . IMGFOLDER . 'icons/pages.png" alt="" /> New Page</h1>';
	} else {
		echo '<h1><img src="' . BASE . IMGFOLDER . 'icons/pages.png" alt="" /> Page: ' . $page['page_title'] . '</h1>';
	}
	
?>

	<form id="page" action="<?php echo BASE . ADMINFOLDER . 'pages' . URL_CAP; ?>" method="post">
