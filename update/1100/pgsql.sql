CREATE TABLE "citations" ("citation_id" SERIAL PRIMARY KEY, "page_id" INTEGER, "citation_type" TEXT, "citation_uri" TEXT, "citation_uri_requested" TEXT, "citation_description" TEXT, "citation_title" TEXT, "citation_site_name" TEXT, "citation_created" TIMESTAMP, "citation_modified" TIMESTAMP);
